    ...
    const graphicClasses = [
        {
            ...
            attributes: [
                ...
                { d: "parent: riferimento statico all'istanza di JCampoMinato", id: 5 },
                { d: "d: livello di difficoltà del gioco", id: 6 },
            ],
            isMethods: true,
            methods: [
                {
                    ...
                    params: [
                        ...
                        { id: 4, type: "int", name: "height" },
                        { id: 5, type: "Boolean", name: "isClassificaAttached" },
                        { id: 6, type: "Difficulty", name: "d" },
                    ],
                ...
                },
                {
                    ...
                    type: "String",
                    name: "format",
                    params: [{ id: 0, type: "String", name: "s" }],
                    description: "Trasforma una stringa dal formato visualizzato nella classifica al formato per il file di salvataggio",
                },
                {
                    id: 11,
                    isPrivate: true,
                    type: "void",
                    name: "sort",
                    params: [{ id: 0, type: "ArrayList<String>", name: "s" }],
                    description: "Ordina un ArrayList di stringhe rappresentanti i giocatori in base al punteggio in ordine decrescente",
                },
            ],
        },
        {
        ...
        },
        {
            ...
            attributes: [
                ...
                { id: 5, d: "NUM_5: Rappresenta una casella con il numero 5, indicando la presenza di cinque mine vicine" },
                { id: 6, d: "NUM_6: Rappresenta una casella con il numero 6, indicando la presenza di sei mine vicine" },
                { id: 7, d: "NUM_7: Rappresenta una casella con il numero 7, indicando la presenza di sei mine vicine" },
                { id: 8, d: "NUM_8: Rappresenta una casella con il numero 8, indicando la presenza di sei mine vicine" },
                ...
                { id: 14, d: "BRUCIATA: Rappresenta una casella bruciata o danneggiata dopo un'esplosione" },
            ],
        },
    ];
